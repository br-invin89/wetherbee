            ...
            >
              ...
              <TouchableOpacity
                style={{
                  ...
                  borderRadius: 27,
                  backgroundColor: "#FFFFFF",
                  top: 15.5 + 15.5 + 15.5 + height * 0.093 /*height * .6872*/,
                  left: "10.67%",
                  justifyContent: "center",
                  alignItems: "center",
                }}
...
class SignUp2Screen extends React.Component {
  ...
  signupFunction = () => {
    if (
      this.props.navigation.state.params.fullName.length == 0 ||
