            ...
            <View style={{ height: 1591 - 44 - 109 + 66 }}>
              ...
              <TouchableOpacity
                style={{
                  ...
                  height: 53.2,
                  boxSizing: "border-box",
                  boxShadow: "0 16px 24px 0 #000000",
                ...
                onPress={
                  /*() => navigate('Search')*/ () =>
                    this.props.navigation.navigate("CompletedTopicList")
                }
              >
                <Text
                  style={{
              ...
              <TouchableOpacity
                ...
                onPress={
                  /*() => navigate('Search')*/ () =>
                    this.props.navigation.navigate("MyPrizes")
                }
              >
                <Text
                  style={{
              ...
              <TouchableOpacity
                style={{
                  ...
                  width: "86.72%",
                  position: "relative",
                  top: 42 + 35 + 12 + 12 + 35 + 12 + 12 + 12 + 12,
                  left: "6.64%",
                  height: 53.2,
                  boxSizing: "border-box",
                  boxShadow: "0 16px 24px 0 rgba(0,0,0,0.02)",
              ...
              <TouchableOpacity
                style={{
                  ...
                  width: "86.72%",
                  position: "relative",
                  top: 42 + 35 + 12 + 12 + 35 + 12 + 12 + 12 + 12 + 30 + 17,
                  left: "6.64%",
                  height: 53.2,
                  boxSizing: "border-box",
                  boxShadow: "0 16px 24px 0 rgba(0,0,0,0.02)",
              ...
              <View
                style={{
                  ...
                  position: "relative",
                  top:
                    42 + 35 + 12 + 12 + 35 + 12 + 12 + 12 + 12 + 30 + 17 + 9.9,
                  left: "6.64%",
                  height: 53.2,
                  boxSizing: "border-box",
                  boxShadow: "0 16px 24px 0 rgba(0,0,0,0.02)",
                ...
                onPress={
                  /*() => navigate('Search')*/ () =>
                    this.props.navigation.navigate("ReadOffline")
                }
              >
                <Text
                  style={{
              ...
              >
                ...
                >
                  ...
                  <Image
                    ...
                    source={require("../assets/Icons/english-language.png")}
                  />
                </View>
              </TouchableOpacity>
...
class ViewProfileScreen extends React.Component {
  ...
  updateName = (response) => {
    ...
    if (
      this.state.response[0].FIRST_NAME +
        " " +
        this.state.response[0].LAST_NAME ==
      this.state.name
    ) {
      console.log("SUCCESS!!!");
      Alert.alert(
        ...
        <View style={{ paddingTop: Platform.OS === "android" ? 25 : 0 }}>
          ...
          <View
            style={{
              ...
              justifyContent: "center",
              alignItems: "center",
              top: Platform.OS === "android" ? 25 + 18 : 18,
            }}
          >
            <Text
              style={{
...
class CompletedTopicListScreen extends React.Component {
  ...
  componentDidMount() {
    this._subscribe = this.props.navigation.addListener("didFocus", () => {
      AsyncStorage.getItem("access_token").then((token) => {
        AsyncStorage.getItem("user").then((user) => {
          Functions.fetchCompletedTopicList(
            token,
            this.updateCompletedTopicList,
            JSON.parse(user).ID
          );
        });
      });
...
class MyPrizesScreen extends React.Component {
  constructor(props) {
    super(props);
  ...
  updatePrizes = (prizes) => {
    ...
    for (i = 0; i < this.state.prizes.length; i++) {
      console.log("==> " + this.state.prizes[i]);
      this.setState({
        totalScore: this.state.totalScore + this.state.prizes[i].POINTS,
      });
    }
  };
  ...
  render() {
    ...
    return (
      <ImageBackground
        source={require("../assets/images/bg_prize.png")}
        style={{
          height: width * 0.69,
          width: width,
          resizeMode: "center",
        ...
        <SafeAreaView>
          <View style={{ paddingTop: Platform.OS === "android" ? 25 : 0 }}>
            <Image
              ...
              source={require("../assets/images/bg_img1.png")}
              activeOpacity={0}
            />
            <View
              style={{
                ...
                position: "absolute",
                top: Platform.OS === "android" ? 25 + 105 : 105,
                left: 37,
                borderRadius: 24,
                backgroundColor: "#FFFFFF",
                boxShadow: "0 20px 36px 0 rgba(0,0,0,0.05)",
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                left: 25,
                zIndex: 1,
                top: Platform.OS === "android" ? 25 + 17 : 17,
              }}
              activeOpacity={1}
            >
              <Image
            ...
            <Text
              style={{
                ...
                lineHeight: 43,
                left: 37,
                top: Platform.OS === "android" ? 25 + 54 : 54,
              }}
              activeOpacity={1}
            >
              Prize
            ...
            <View
              style={{
                ...
                backgroundColor: "#FFFFFF",
                position: "absolute",
                top: Platform.OS === "android" ? 25 + 175 : 175,
              }}
              activeOpacity={1}
            ></View>
            <FlatList
              style={{
                height: height - (205 - 30),
                width: "100%",
                left: 0,
                top: Platform.OS === "android" ? 25 + 205 - 30 : 205 - 30,
                position: "absolute",
                paddingTop: 30,
              }}
              vertical
...
class PhoneNumberScreen extends React.Component {
  ...
  updatePhoneNumber = (response) => {
    ...
    if (
      this.state.response[0].PHONE_NUMBER ==
      this.state.phoneNum.replace(/[-+()\s]/g, "")
    ) {
      console.log("SUCCESS!!!");
      Alert.alert(
...
class NotificationScreen extends React.Component {
  ...
  data = [
    ...
    },
    {
      ...
      subTitle:
        "Keytar McSweeney's Williamsburg, ready made leggings try-hard.",
    },
    {
      ...
      subTitle:
        "Portland ugh fashion axe Helvetica, YOLO Echo Park Austin gas.",
    },
  ];
